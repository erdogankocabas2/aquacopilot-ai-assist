...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aquarium Copilot — AI-powered care for healthier tanks" },
      { property: "og:description", content: "Scate AI case study: research, pain points, and an AI app concept for US aquarium owners." },
